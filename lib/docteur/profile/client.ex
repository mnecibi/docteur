defmodule Docteur.Profile.Client do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Docteur.Repo)
  ...
  """
  def valid_password?(%Docteur.Profile.Client{hashed_password: hashed_password}, password)
