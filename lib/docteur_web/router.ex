defmodule DocteurWeb.Router do
  use DocteurWeb, :router

  import DocteurWeb.ClientAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {DocteurWeb.Layouts, :root}
  ...
  # scope "/api", DocteurWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:docteur, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: DocteurWeb.Telemetry
  ...
  scope "/", DocteurWeb do
    ...
    live_session :redirect_if_client_is_authenticated,
      on_mount: [{DocteurWeb.ClientAuth, :redirect_if_client_is_authenticated}] do
  ...
  scope "/", DocteurWeb do
    ...
    live_session :require_authenticated_client,
      on_mount: [{DocteurWeb.ClientAuth, :ensure_authenticated}] do
      live "/", HomeLive, :home
  ...
  scope "/", DocteurWeb do
    ...
    live_session :current_client,
      on_mount: [{DocteurWeb.ClientAuth, :mount_current_client}] do
