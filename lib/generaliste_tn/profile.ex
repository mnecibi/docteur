defmodule GeneralisteTN.Profile do
  @moduledoc """
  The Profile context.
  """
  ...
  alias GeneralisteTN.Profile.{Client, ClientToken, ClientNotifier}
  ...
  """
  def deliver_client_update_email_instructions(
        %Client{} = client,
        current_email,
        update_email_url_fun
      )
      when is_function(update_email_url_fun, 1) do
    {encoded_token, client_token} =
      ClientToken.build_email_token(client, "change:#{current_email}")
  ...
  defp confirm_client_multi(client) do
    ...
    |> Ecto.Multi.delete_all(
      :tokens,
      ClientToken.by_client_and_contexts_query(client, ["confirm"])
    )
  end
