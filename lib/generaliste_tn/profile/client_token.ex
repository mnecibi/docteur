defmodule GeneralisteTN.Profile.ClientToken do
  use Ecto.Schema
  import Ecto.Query
  alias GeneralisteTN.Profile.ClientToken
  ...
  schema "clients_tokens" do
    ...
    belongs_to :client, GeneralisteTN.Profile.Client
  ...
  @doc """
  Builds a token and its hash to be delivered to the client's email.
  ...
  This is used to validate requests to change the client
  ...
  """
  def by_client_and_contexts_query(client, :all) do
    from t in ClientToken, where: t.client_id == ^client.id
  end

  def by_client_and_contexts_query(client, [_ | _] = contexts) do
