defmodule GeneralisteTN.Profile.Client do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, GeneralisteTN.Repo)
  ...
  """
  def email_changeset(client, attrs, opts \\ []) do
    client
    |> cast(attrs, [:email])
    |> validate_email(opts)
    |> case do
  ...
  """
  def valid_password?(%GeneralisteTN.Profile.Client{hashed_password: hashed_password}, password)
